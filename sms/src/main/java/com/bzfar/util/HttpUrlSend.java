...
public class HttpUrlSend {
         ...
         * 向指定URL发送GET方法的请求
         */
        public static String sendGet(String phone, String content){
            try{
                String encodecontent = URLEncoder.encode(content, "GBK");
                String param1 = "SpCode=264268&LoginName=wh_bzcy&Password=e77f50802882378e24d7915fde54e3fe&SerialNumber=&ScheduleTime=&f=1&MessageContent="+encodecontent+"&UserNumber="+phone;
                return sendGet("https://api.ums86.com:9600/sms/Api/Send.do", param1, null);
            }catch (Exception e){
